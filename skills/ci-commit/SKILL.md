---
name: ci-commit
description: Use when creating git commits for session changes with clear, atomic messages in CI environments
---
...
3. **Execute upon confirmation:**
   ...
   - Include thoughts/ directory content as part of commits (research, plans, handoffs are all committable)
